...
describe("Order unit tests", () => {
  it("should generate an id even if you don't enter", () => {
    const item = new OrderItem("i1", "p1", "Item 1", 200, 1);
  ...
  it("should calculate total", () => {
    const item = new OrderItem("i1", "p1", "Item 1", 200, 2);
    const item2 = new OrderItem("i2", "p2", "Item 1", 300, 3);
  ...
  it("should check if the item quantity is less or equal zero", () => {
    expect(() => {
      const item = new OrderItem("i1", "p1", "Item 1", 200, 0);
